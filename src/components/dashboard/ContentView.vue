...
const beforeUpdateRecord = ref<Record | null>(null);
...
async function updateRecord() {
  ...
  try {
    ...
    if (selectedRecord.value) {
      sendRecordChangeNotify(NotifyType.DELETE_RECORD_SUCCESS, newRecord);
    }
    beforeUpdateRecord.value = selectedRecord.value;
    selectedRecord.value = null;
